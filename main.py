...
if page == "Upload Data":
    ...
    uppath = st.file_uploader("Drop your file here", type=["csv"])
...
# Dashboard Page
    ...
    with col22: 
        fig = px.line(st.session_state.df, x="Tanggal & Waktu", y="Jumlah Produk", color="Kategori", title="Line Chart Berdasarkan Kategori")
        st.plotly_chart(fig)
    ...
    option1 = st.selectbox("Select Cluster:", optionCluster)
    if option1 == "All":
